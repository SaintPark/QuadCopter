...
{
  long ReferenceRollRate;  // Reference roll rate, in deg/s * 50
  long ReferencePitchRate; // Reference pitch rate, in deg/s * 50
  long ReferenceYawRate; // Reference yaw rate, in deg/s * 50

  ReferenceRollRate  = (long)((radio_in[CH_ROLL]  - radio_trim[CH_ROLL]) * 1.5f * REVERSE_ROLL);// floating point value of reference roll rate command - between -15 and 15 deg/s
  ReferencePitchRate = (long)((radio_in[CH_PITCH] - radio_trim[CH_PITCH]) * 1.5f * REVERSE_PITCH);// floating point value of reference pitch rate command - between -15 and 15 deg/s
  ReferenceYawRate =   (long)((radio_in[CH_RUDDER] - radio_trim[CH_RUDDER]) * 1.5f * REVERSE_RUDDER);// floating point value of reference pitch rate command - between -15 and 15 deg/s
